...
public class Debug {
	public static void main(String[] args) {
		...
		// board.getTilesWithValue(j).get(1).addBuilding(new Building(BuildingType.CITY,
		// players[0], new Place()));
		System.out.println("Tile w value " + j + ": " + board.getTilesWithValue(j).toString());
		// Logic.rollDice();
		players[0].checkVP();
		System.out.println(players[0].toString());
		// System.out.println("Roll: " + Logic.roll + ", " + "Tile: "+
		// board.getTilesWithValue(Logic.roll).toString());
